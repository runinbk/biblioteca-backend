...
const gets = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const obj = yield prestamo_model_1.default.findAll();
    res.json({ obj });
});
exports.gets = gets;
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const obj = yield prestamo_model_1.default.findByPk(id);
    if (obj) {
        res.json({ obj });
    }
    else {
        res.status(404).json({
            msg: `No existe un Prestamo con el id : ${id}`
        });
    }
});
exports.get = get;
const post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { body } = req;
    try {
        const obj = new prestamo_model_1.default(body);
        yield obj.save();
        res.json({
            msg: 'El Prestamo se creo correctamente',
            obj
        });
    }
    catch (error) {
    ...
    try {
        ...
        if (!obj) {
            return res.status(404).json({
                mensaje: `No existen un Prestamo con ese ID`,
            });
        }
        yield obj.update(body);
        res.json({
            msg: `El Prestamo con el id ${id} fue actualizado correctamente`,
            obj
        });
    }
    catch (error) {
...
const delet = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!obj) {
        return res.status(404).json({
            msg: 'No existe Prestamo con el id: ' + id
        });
    }
    yield obj.destroy();
    res.json({
        msg: `El Prestamo con el id ${id} fue eliminado permanentemente con exito..!!!`,
        obj
    });
});
exports.delet = delet;
const deletState = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!obj) {
        return res.status(404).json({
            msg: 'No existe el Prestamo con el id : ' + id
        });
    }
    yield obj.update({ state: false });
    res.json({
        msg: `El Prestamo con el id ${id} fue eliminado con exito..!!!`,
        obj
    });
});
